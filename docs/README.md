...
| recon/ | Six evidence reports (official mcp-client, distribution, core APIs, UI contracts, chamber bridge, runtime test env) |
| milestones/M0.md | M0 smoke evidence log (install, inventory, ns R/W + revision, credentials) |
| milestones/M1.md | M1 usable-build evidence + honest gaps |
