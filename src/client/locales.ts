...
export const en = {
  ...
  'import.hint': 'Paste one server from an mcpServers / opencode snippet. Secret values go to the write-only fields; nothing is saved until you save.',
...
export const zh: Record<SettingsKey, string> = {
  ...
  'import.hint': '粘贴 mcpServers / opencode 片段中的单个服务器。密钥值进入仅写入字段，保存前不会落盘。',
